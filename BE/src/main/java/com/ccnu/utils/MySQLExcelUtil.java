...
public class MySQLExcelUtil {
     ...
     * @throws SQLException
     */
    public static int exportFromMySQLToExcel(String filePath, String ...excludeTables) throws SQLException {
        ...
        String table_str[]={"2-2-6","2-1-4","bachelor_science","confirm_information","2-1-1","data_dictionary",
        "data_dictionary_type","1-1-2","1-1-1","1-1-1_xu1","1-1-1_xu2","2-1-2","2-1-5","2-2-5","2-2-4","2-2-3",
                "2-1-3","2-2-7","2-2-2","2-2-1","1-2-1","specialized_technical_job","subject_directory","talent_selection_project",
                "user_account"
        };
...
//                int ran1 = r.nextInt(100);
                ...
                //创建一张表
                HSSFSheet sheet = workbook.createSheet(table_str[count_table]);
                count_table++;
                //初始化第一行 显示表中的列
        ...
        try {
            ...
            filePath = filePath + "\\" + "BDXXXT" + "_export.xls";
    ...
    public static void importFromExcelToMySQL(String xlsFile){
